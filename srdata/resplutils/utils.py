...
# 常量
rgb_weights = torch.FloatTensor([65.481, 128.553, 24.966]).cuda()
...
imagenet_mean_cuda = torch.FloatTensor(
    [0.485, 0.456, 0.406]).cuda().unsqueeze(0).unsqueeze(2).unsqueeze(3)
imagenet_std_cuda = torch.FloatTensor(
    [0.229, 0.224, 0.225]).cuda().unsqueeze(0).unsqueeze(2).unsqueeze(3)
